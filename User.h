...
typedef std::shared_ptr<RecommendationSystem> sys_ptr;

class User {
private:
    std::string _name;
    rank_map _ranks;
    sys_ptr _recommendations;
...
public:
     ...
     */
    friend std::ostream &operator<<(std::ostream &s, User &user);
};

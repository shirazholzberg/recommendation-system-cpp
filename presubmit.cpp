...
{
  auto rs = RecommendationSystemLoader::create_rs_from_movies ("presubmit.in_m");
  std::vector<User> user = UsersLoader::create_users ("presubmit.in_u", std::move (rs));
...
int TestComparison_4 ()
{
  ...
  auto rs = RecommendationSystemLoader::create_rs_from_movies ("presubmit.in_m4");
  std::vector<User> user = UsersLoader::create_users ("presubmit.in_u4", std::move (rs));
...
{
  auto rs = RecommendationSystemLoader::create_rs_from_movies ("presubmit.in_m6");
  std::vector<User> user = UsersLoader::create_users ("presubmit.in_u6", std::move (rs));
...
{
  auto rs = RecommendationSystemLoader::create_rs_from_movies ("presubmit.in_m7");
  std::vector<User> user = UsersLoader::create_users ("presubmit.in_u7", std::move (rs));
...
int TestComparison_14 ()
{
  ...
  std::vector<User> user = UsersLoader::create_users ("presubmit.in_u14", std::move (rs));
...
int TestComparison_15 ()
{
  try
    {
      auto rs = RecommendationSystemLoader::create_rs_from_movies ("presubmit.in_m15");
//                              "presubmit_18.in_m");
...
//        rs->add_movie("TheyWereExpendable",1967,{1,2,8,5,9});
//        rs->add_movie("Harakiri",1967,{2,6,6,10,5});
      auto rs = RecommendationSystemLoader::create_rs_from_movies ("presubmit.in_m16");
      auto users = UsersLoader::create_users ("presubmit.in_u16", std::move (rs));
//                              "presubmit_18.in_m");
      std::cout << "You didn't throw an exception when loading an invalid "
